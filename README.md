...
public class Raphael {
    String nome = "Raphael Felipe Santiago da Silva";
    String profissao = "Desenvolvedor em formação";
    String areaDeEstudo = "Tecnologia da Informação";
    String foco = "Java, Spring Boot, API REST, Bancos de Dados";
    String idioma = "Inglês intermediário";
    String objetivo = "Criar soluções eficientes, seguras e escaláveis";
```
...
<a href="https://www.linkedin.com/in/raphael-santiago-32903826b/"><img src="https://img.shields.io/badge/-LinkedIn-0077B5?style=flat&logo=Linkedin&logoColor=white"/></a>
[![GitHub followers](https://img.shields.io/github/followers/leandrocgsi.svg?style=social&label=Follow)](https://github.com/RaphaelSantt?tab=followers)
